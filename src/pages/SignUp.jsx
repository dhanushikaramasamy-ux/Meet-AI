...
export default function SignUp() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toast.success("Account created! Welcome to MeetAI.");
      navigate("/");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 items-center justify-center p-12 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-96 h-96 rounded-full bg-white/5 -translate-y-1/2 -translate-x-1/2" />
        <div className="absolute bottom-0 right-0 w-72 h-72 rounded-full bg-white/5 translate-y-1/2 translate-x-1/2" />

        <div className="relative text-white max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center text-2xl font-bold mb-8">
            AI
          </div>
          <h2 className="text-3xl font-bold mb-4">Start your free trial</h2>
          <p className="text-primary-100 text-lg leading-relaxed mb-10">
            Join 500+ teams already using MeetAI to turn meetings into
            actionable results.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          {/* Logo */}
          <div>
            <Link to="/landing" className="flex items-center gap-2.5 mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Free forever for up to 10 meetings/month
            </p>
          </div>
