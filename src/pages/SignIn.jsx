    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center text-white max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center text-2xl font-bold mx-auto mb-8">
            AI
          </div>
          <h2 className="text-3xl font-bold mb-4">AI Meeting Intelligence</h2>
          <p className="text-primary-100 text-lg leading-relaxed">
            Transform every meeting into clear action items, summaries, and team
            insights — automatically.
          </p>
          <div className="mt-10 grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-2xl font-bold">10K+</p>
              <p className="text-primary-200 text-xs mt-1">Meetings</p>
            </div>
            <div>
              <p className="text-2xl font-bold">98%</p>
              <p className="text-primary-200 text-xs mt-1">Accuracy</p>
            </div>
            <div>
              <p className="text-2xl font-bold">85%</p>
              <p className="text-primary-200 text-xs mt-1">Time Saved</p>
            </div>
          </div>
        </div>
      </div>
